...
$\chi_i (\bm{x}), \ i=1,\dots,N$ with spin-spatial
...
of basis elements.
These equations can be written more compactly as the matrix equation:

$$ FC = SC\epsilon , $$

where $\epsilon$ is a vector containing the energy eigenvalues
of the basis elements. The Fock matrix is further decomposed into:
