...
\begin{figure}[h]
    \centering
    \includegraphics[width=\linewidth]{convergence_lennard_jones.png}
    \caption{Convergence}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\linewidth]{energy_lennard_jones.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\linewidth]{rdf_lennard_jones.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\linewidth]{msd_lennard_jones.png}
