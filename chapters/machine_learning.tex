...
\subsection{Optimization}\label{chap:optimization}
...
Another method is to rescale the inputs to the range of activation
...
\begin{figure}[H]
    \includegraphics[width=\textwidth]{gradient_descent_oscillation.png}
